...
const sectionPreviews = [
  {
    label: "Histoire",
    to: "/our-story",
    title: "Un pont entre deux mondes",
    ...
    placeholderHint: "carte du Vietnam ou lanterne traditionnelle",
  },
  {
    label: "Culture café",
    to: "/culture",
    title: "L'art du café vietnamien",
    ...
    placeholderHint: "chapeau conique ou lanterne",
  },
  {
    label: "Partenaires",
    to: "/partenaires",
    title: "Producteurs et torréfacteurs",
    ...
    placeholderHint: "deux personnes autour d'un café vietnamien, ou torréfacteur",
  },
  {
    label: "Nos produits",
    to: "/products",
    title: "Une sélection d'exception",
    text: "Trois variétés, trois origines, une exigence commune. Découvrez nos cafés vietnamiens sélectionnés pour leur caractère et leur qualité.",
    placeholderHint: "grains de café avec paquet ouvert",
  },
  {
    label: "Nouveautés",
    to: "/nouveaute",
    ...
    placeholderHint: "personne élégante en terrasse de café, lisant le journal",
  },
]
...
// ─── SECTION PREVIEW — alternating left/right with placeholder image ────────
function SectionPreview({ preview, index, isMobile }) {
  const isRight = !isMobile && index % 2 === 1  // alternate: image left, right, left...
  ...
  return (
    <div style={{ background: "#020100", color: "var(--color-cream)", position: "relative", overflow: "hidden", width: "100%" }}>
      ...
      zIndex: 0,
        ...
        <div ref={heroRef} className="relative z-10 px-6" style={{width: "40%", maxWidth: "1200px", padding: " 1rem",position: "relative", }}>
          {/*
            ── HERO TEXT ──
                      */}
          {/* Opening quote */}
      ...
      <section className="relative py-70 px-6 overflow-hidden">
        <Orb top="20%" left="10%" size="45vw" opacity={0.1} />    
        <Orb top="60%" left="90%" size="45vw" opacity={0.1} />
        <Orb top="90%" left="20%" size="40vw" opacity={0.08} />
        <div className="relative z-10 max-w-4xl mx-auto">           {/*max-w-5xl → width*/}
